...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Nodo central entre talento humano y producci├│n.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `asignar_tarea` VALUES (1,1,1,4,'2026-06-07','2026-06-07','completada',1.00),(2,1,2,4,'2026-06-07','2026-06-07','completada',10.00),(3,1,3,4,'2026-06-07','2026-06-07','completada',NULL),(4,1,4,5,'2026-06-07','2026-06-07','completada',NULL),(5,1,5,11,'2026-06-10','2026-06-10','completada',NULL),(6,1,6,6,'2026-06-20',NULL,'pendiente',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='C├ílculo de precio por lote.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calculo_precio` VALUES (5,5,0.00,40.00,0.00,30.00,0,4.42,'2026-06-08',0),(6,4,0.00,130.00,0.00,30.00,0,4.42,'2026-06-08',0),(7,6,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(8,7,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(9,8,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(10,9,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(11,10,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(12,11,0.00,100.00,0.00,30.00,0,1.08,'2026-06-10',0),(13,12,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(14,13,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0),(15,14,0.00,0.00,0.00,30.00,0,1.08,'2026-06-10',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de clientes.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cliente` VALUES (1,'V','31205896','Mayra','Perez','04123005644',1),(2,'V','12451590','Detzy','Acosta','04144237719',0),(3,'V','31205898','Detzy','Acosta','04144237719',0);
...
INSERT INTO `compra` VALUES (1,1,'2026-06-08','Factura',NULL,10.00,0.00,10.00,'',NULL,1,'2026-06-08 16:39:54','2026-06-08 16:56:26'),(2,1,'2026-06-09','Factura',NULL,200.00,0.00,200.00,'cancelada',NULL,1,'2026-06-09 00:25:25','2026-06-09 00:29:38'),(3,1,'2026-06-09','Factura',NULL,200.00,0.00,200.00,'pendiente',NULL,0,'2026-06-09 00:30:00','2026-06-09 00:31:13'),(4,1,'2026-06-08','Factura',NULL,50.00,0.00,50.00,'pendiente',NULL,0,'2026-06-09 03:46:05','2026-06-09 03:51:59'),(5,1,'2026-06-08','Factura',NULL,50.00,0.00,50.00,'pendiente',NULL,1,'2026-06-09 03:52:23','2026-06-09 03:52:23'),(6,1,'2026-06-08','Factura',NULL,45.00,0.00,45.00,'pendiente',NULL,1,'2026-06-09 03:58:32','2026-06-09 03:58:32'),(7,1,'2026-06-09','Factura',NULL,20.00,0.00,20.00,'pendiente',NULL,1,'2026-06-09 04:05:37','2026-06-09 04:05:37'),(8,1,'2026-06-18','Factura',NULL,5.00,0.00,5.00,'pendiente',NULL,1,'2026-06-19 03:13:59','2026-06-19 03:13:59');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Todo consumo debe estar justificado por una tarea.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `consumo_insumos` VALUES (1,1,3,1.00,10.00,1.00,'2026-06-07'),(2,2,6,5.00,20.00,10.00,'2026-06-07'),(3,3,6,1.00,20.00,5.00,'2026-06-07'),(4,4,6,2.00,20.00,4.00,'2026-06-07'),(5,5,6,5.00,20.00,10.00,'2026-06-10');
...
INSERT INTO `cuentas_pagar` VALUES (1,5,50.00,50.00,NULL,'pendiente',NULL,1,'2026-06-09 03:52:23','2026-06-09 03:52:23'),(2,6,45.00,45.00,NULL,'pendiente',NULL,1,'2026-06-09 03:58:32','2026-06-09 03:58:32'),(3,7,20.00,20.00,NULL,'pendiente',NULL,1,'2026-06-09 04:05:37','2026-06-09 04:05:37'),(4,8,5.00,5.00,NULL,'pendiente',NULL,1,'2026-06-19 03:14:00','2026-06-19 03:14:00');
...
INSERT INTO `detalle_ornatos` VALUES (3,1,4,20,4.42,88.40);
...
INSERT INTO `detalle_venta` VALUES (3,3,10,20,10.00),(6,6,13,20,100.00),(7,7,4,2,10.00),(8,8,4,1,4.42),(9,9,4,1,4.42),(10,10,4,1,4.42),(11,11,4,1,4.44),(12,12,4,1,4.42),(13,13,5,5,4.42),(14,14,4,1,4.42);
...
INSERT INTO `especie` VALUES (1,'dsadasdasdasa',NULL,1),(2,'dadada',NULL,1),(3,'dsadasdasdasad',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Herramientas con ciclo de vida propio.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `herramienta` VALUES (1,'Pala',1,NULL,'en_uso','2026-06-02','2026-06-02',NULL,1),(2,'Martillo',1,'nose','danada','2026-06-02','2026-06-02','dsadasdada',0),(3,'Pico',1,'herramienta','en_uso','2026-06-02','2026-06-02',NULL,1),(5,'Pico',1,'nose','ok',NULL,NULL,NULL,1),(6,'mmm',2,'nose nada','baja','2026-06-24','2026-06-24',NULL,1),(7,'mmm',2,'nose nada','baja','2026-06-24','2026-06-24',NULL,1),(8,'mmm',2,'nose nada','baja','2026-06-24','2026-06-24',NULL,1),(9,'mmm',2,'nose nada','baja','2026-06-24','2026-06-24',NULL,1),(10,'mmm',2,'nose nada','baja','2026-06-24','2026-06-24',NULL,1),(11,'mmmmm',4,'mmmmm','disponible','2026-06-23','2026-06-24',NULL,1),(12,'mmmmm',4,'mmmmm','disponible','2026-06-23','2026-06-24',NULL,1),(13,'mmmmm',4,'mmmmm','disponible','2026-06-23','2026-06-24',NULL,1),(14,'mmmmm',4,'mmmmm','disponible','2026-06-23','2026-06-24',NULL,1),(15,'mmmmm',4,'mmmmm','disponible','2026-06-23','2026-06-24',NULL,1),(16,'rrrr',1,'nn','disponible','2026-06-23','2026-06-24',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inventario de insumos.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `insumo` VALUES (2,14,'Fertilizante','dasd',0.01,0.01,0),(3,5,'Semillas de Simon','Semillas',0.00,10.00,0),(4,5,'Semillas de Simon','Semillas',20.00,0.00,0),(5,5,'Semillas de Simon','Semillas',20.00,0.00,0),(6,5,'Semillas de Simon','Semillas',10.00,20.00,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unidad de producci├│n.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lote` VALUES (4,2,3,'2026-06-01',1,26,0.00,'Activo','germinado','Siembra',NULL,'public/assets/uploads/batches/batch_1780330649_5cde51b9.jpg',1),(5,2,3,'2026-06-07',20,15,0.00,'Vivo','germinado','Siembra',NULL,NULL,1),(6,5,NULL,'2026-06-08',1,1,0.00,'Activo','germinado','Compra','Ingresado por compra #1',NULL,1),(7,5,3,'2026-06-08',20,24,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(8,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(9,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(10,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(11,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(12,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(13,5,3,'2026-06-08',20,18,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(14,5,3,'2026-06-08',20,20,10.00,'Activo','germinado','Compra','Ingresado por compra #3',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unifica venta, ornato, donaci├│n e intercambio de plantas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `movimiento_planta` VALUES (1,'intercambio',1,1,'2026-06-24',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Detalle por lote del movimiento de plantas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `movimiento_planta_detalle` VALUES (1,1,13,'salida',2,NULL,NULL,1),(2,1,7,'entrada',4,NULL,NULL,1);
...
INSERT INTO `ornatos` VALUES (1,1,'Venta',NULL,NULL,88.40,'2026-06-09',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de plantas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plantas` VALUES (2,1,'Cactuspro','Simon',0,'public/assets/uploads/plants/plant_1780267336_412abda4.png',1),(4,NULL,'Planta Test','Planta Test',0,NULL,1),(5,NULL,'Girasol','Girasol',160,NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de proveedores.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proveedores` VALUES (1,'Plantas nuevas','J-123456789','Prueba','04123232323',1);
...
INSERT INTO `recoleccion_semillas` VALUES (8,1,6,'2026-06-18',NULL,'Pendiente','Adiós',0),(9,1,5,'2026-06-18',NULL,'Pendiente',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de tareas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tareas` VALUES (1,'FJadfhjdkf','No hay detalles',1,NULL),(2,'FJadfhjdkf',NULL,1,NULL),(3,'FJadfhjdkf','jhjhj',1,NULL),(4,'JDiksadjasldas','dasdasdadasdas',1,NULL),(5,'JDiksadjasldas',NULL,1,NULL),(6,'Moler el queso','adasd',1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Espacios f├¡sicos del vivero.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ubicacion` VALUES (2,'Invernadero Central','Invernadero principal','A',1),(3,'Almacén Norte','Almacén de insumos','B',1),(4,'Vivero Exterior','Área de exposición','C',1),(5,'Estante A',NULL,'dxsdsdsd',1),(6,'Estante B',NULL,'dasdasdasa',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unidades de medida para insumos.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `unidad_medida` VALUES (1,'Kilogramo','kg',1),(2,'Gramo','g',1),(3,'Litro','L',1),(4,'Mililitre','mL',0),(5,'Unidad','und',1),(6,'Metro','m',1),(7,'CentÝmetro','cm',1),(8,'Saco','saco',1),(9,'Bolsa','bolsa',1),(10,'Paquete','pqte',1),(11,'Gal¾n','gal',1),(12,'Caja','caja',1),(13,'Rollos','rllo',1),(14,'Bidon','bidon',1),(15,'Centigrados',NULL,1),(16,'Centigrados',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Herramienta ligada a una tarea.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `uso_herramienta` VALUES (1,3,5,'2026-06-07','','ok');
...
-- Dump completed on 2026-06-24 17:55:36
