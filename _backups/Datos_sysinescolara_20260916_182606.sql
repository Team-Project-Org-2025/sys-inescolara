...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Catálogo botánico.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `especie` VALUES (1,'ornamental',NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unidad de producción. Precio calculado en código.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `lote` VALUES (1,1,1,'2026-09-16',2,2,2.00,5,3,2,NULL,NULL,1,30.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Catálogo de plantas.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `plantas` VALUES (1,1,'ssss','rosa',0,'public/assets/uploads/plants/plant_1789597176_d2cb10b9.jpg',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Espacios físicos del vivero.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `ubicacion` VALUES (1,'suspire',NULL,'Interno',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unidades de medida para insumos.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `unidad_medida` VALUES (1,'Unidad','ud',1),(2,'Kilogramo','kg',1),(3,'Gramo','g',1),(4,'Litro','L',1),(5,'Mililitro','ml',1),(6,'Metro','m',1),(7,'Metro Cuadrado','m²',1),(8,'Bulto','bulto',1),(9,'Guacal','guacal',1);
...
-- Dump completed on 2026-09-16 18:26:07
