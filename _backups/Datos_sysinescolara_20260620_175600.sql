...
INSERT INTO `ajuste_inventario` VALUES (1,6,1,'salida',20,'DSDSD','2026-06-09'),(2,6,1,'entrada',40,'oooo','2026-06-19');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Nodo central entre talento humano y producci├│n.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `asignar_tarea` VALUES (1,1,1,4,'2026-06-07','2026-06-07','completada',1.00),(2,1,2,4,'2026-06-07','2026-06-07','completada',10.00),(3,1,3,4,'2026-06-07','2026-06-07','completada',NULL),(4,1,4,5,'2026-06-07','2026-06-07','completada',NULL),(5,2,5,15,'2026-06-20',NULL,'cancelada',NULL),(6,2,6,9,'2026-06-20',NULL,'cancelada',NULL),(7,3,7,14,'2026-06-20',NULL,'pendiente',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='C├ílculo de precio por lote.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calculo_precio` VALUES (5,5,0.00,40.00,0.00,30.00,0,4.42,'2026-06-08',0),(6,4,0.00,130.00,0.00,30.00,0,4.42,'2026-06-08',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de clientes.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cliente` VALUES (1,'Mayra Perez','04123005644',1),(2,'Empresa Jardín','contacto@empresa.com',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Todo consumo debe estar justificado por una tarea.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `consumo_insumos` VALUES (1,1,3,1.00,10.00,1.00,'2026-06-07'),(2,2,6,5.00,20.00,10.00,'2026-06-07'),(3,3,6,1.00,20.00,5.00,'2026-06-07'),(4,4,6,2.00,20.00,4.00,'2026-06-07');
...
INSERT INTO `cuentas_pagar` VALUES (1,5,50.00,50.00,NULL,'pendiente',NULL,1,'2026-06-09 03:52:23','2026-06-09 03:52:23'),(2,6,45.00,45.00,NULL,'pendiente',NULL,1,'2026-06-09 03:58:32','2026-06-09 03:58:32'),(3,7,20.00,20.00,NULL,'pendiente',NULL,1,'2026-06-09 04:05:37','2026-06-09 04:05:37');
...
INSERT INTO `detalle_ornatos` VALUES (2,1,10,20,0.00,0.00);
...
INSERT INTO `detalle_venta` VALUES (3,3,10,20,10.00),(6,6,13,20,100.00),(7,7,15,5,10.00);
...
INSERT INTO `especie` VALUES (1,'dsadasdasdasa',NULL,1),(2,'dadada',NULL,1),(3,'dsadasdasdasad',NULL,1),(4,'Rosales','Rosae',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Herramientas con ciclo de vida propio.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `herramienta` VALUES (1,'Pala',NULL,'en_uso','2026-06-02','2026-06-02',NULL,1),(2,'Martillo','nose','en_uso','2026-06-02','2026-06-02','dsadasdada',1),(3,'Pico','herramienta','en_uso','2026-06-02','2026-06-02',NULL,1),(5,'Pico','nose','ok',NULL,NULL,NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inventario de insumos.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `insumo` VALUES (2,14,'Fertilizante','dasd',0.01,0.01,0),(3,5,'Semillas de Simon','Semillas',0.00,10.00,0),(4,5,'Semillas de Simon','Semillas',20.00,0.00,0),(5,5,'Semillas de Simon','Semillas',20.00,0.00,0),(6,5,'Semillas de Simon','Semillas',40.00,20.00,1),(7,16,'Sustrato Premium','Insumos',100.00,5.00,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Unidad de producci├│n.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lote` VALUES (4,2,3,'2026-06-01',1,30,0.00,'Vivo','germinado','Siembra',NULL,'public/assets/uploads/batches/batch_1780330649_5cde51b9.jpg',1),(5,2,3,'2026-06-07',20,20,0.00,'Vivo','germinado','Siembra',NULL,NULL,1),(6,5,NULL,'2026-06-08',1,1,0.00,'Activo','germinado','Compra','Ingresado por compra #1',NULL,0),(7,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(8,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(9,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(10,5,3,'2026-06-08',20,100,10.00,'Crecimiento','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(11,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(12,5,3,'2026-06-08',20,20,10.00,'Activo','en_crecimiento','Compra','Ingresado por compra #2',NULL,1),(13,5,3,'2026-06-08',20,0,10.00,'Agotado','en_crecimiento','Compra','Ingresado por compra #2',NULL,0),(14,5,3,'2026-06-08',20,11,10.00,'Crecimiento','germinado','Compra','Ingresado por compra #3',NULL,1),(15,6,7,'2026-06-20',50,50,0.00,'Activo',NULL,'Siembra',NULL,NULL,1);
...
INSERT INTO `ornatos` VALUES (1,1,'Donacion',NULL,NULL,0.00,'2026-06-09',1);
...
INSERT INTO `pago_venta` VALUES (3,3,'',200.00,NULL,'2026-06-08 23:25:26','registrado',NULL,NULL,NULL,'2026-06-08 23:14:38'),(6,6,'transferencia',10.00,NULL,'2026-06-08 23:25:26','registrado',NULL,NULL,NULL,'2026-06-08 23:23:58');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de plantas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plantas` VALUES (2,1,'Cactuspro','Simon',0,'public/assets/uploads/plants/plant_1780267336_412abda4.png',1),(4,NULL,'Planta Test','Planta Test',0,NULL,1),(5,NULL,'Girasol','Girasol',160,NULL,1),(6,4,'Rosa gallica','Rosa de Castilla',0,NULL,1),(7,3,'buche','buche',0,NULL,1);
...
INSERT INTO `recoleccion_semillas` VALUES (1,1,2,'2026-06-07','2026-06-07','Realizada','Nada'),(2,1,3,'2026-06-07','2026-06-07','Realizada',NULL),(3,1,2,'2026-06-07','2026-06-07','Realizada',NULL),(4,1,2,'2026-06-07','2026-06-07','Realizada',NULL),(5,1,6,'2026-06-07',NULL,'Pendiente',NULL);
...
INSERT INTO `recoleccion_semillas_detalle` VALUES (1,1,'Simon','Semillas de Simon',5,1.00),(2,2,'Simon','Semillas de Simon',5,20.00),(3,3,'Simon','Semillas de Simon',5,20.00),(4,4,'Simon','Semillas de Simon',5,10.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de tareas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tareas` VALUES (1,'FJadfhjdkf','No hay detalles',1,NULL),(2,'FJadfhjdkf',NULL,1,NULL),(3,'FJadfhjdkf','jhjhj',1,NULL),(4,'JDiksadjasldas','dasdasdadasdas',1,NULL),(5,'Riego','Riego diario de lotes',1,'Mantenimiento'),(6,'Regar plantas',NULL,1,NULL),(7,'Regar plantas',NULL,1,NULL);
...
INSERT INTO `trabajadores` VALUES (1,'Enyell','Duarte','31511825','04120000000','Administrador',1),(2,'Maria','Rodriguez','20123456','04140000000','Encargada de Campo',1),(3,'Jose','Mendoza','24157299','04123344556','Encargado de Campo',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Espacios f├¡sicos del vivero.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ubicacion` VALUES (2,'Invernadero Central','Invernadero principal','A',1),(3,'Almacén Norte','Almacén de insumos','B',1),(4,'Vivero Exterior','Área de exposición','C',1),(5,'Prueba',NULL,'dxsdsdsd',1),(6,'Nueva',NULL,'dasdasdasa',1),(7,'Zona de Germinación','Invernadero A1','Zona A',1);
...
INSERT INTO `unidad_medida` VALUES (1,'Kilogramo','kg',1),(2,'Gramo','g',1),(3,'Litro','L',1),(4,'Mililitro','mL',1),(5,'Unidad','und',1),(6,'Metro','m',1),(7,'CentÝmetro','cm',1),(8,'Saco','saco',1),(9,'Bolsa','bolsa',1),(10,'Paquete','pqte',1),(11,'Gal¾n','gal',1),(12,'Caja','caja',1),(13,'Rollos','rllo',1),(14,'Bidon','bidon',1),(15,'Litro','L',1),(16,'Kilogramo','kg',1);
...
INSERT INTO `venta` VALUES (3,'VEN-20260608-001',1,1,'credito','pendiente',16.00,'2026-06-09 03:13:00',NULL,NULL,1,'2026-06-08 23:14:38','2026-06-08 23:14:38'),(6,'VEN-20260608-002',1,1,'credito','pendiente',16.00,'2026-06-09 03:21:00','2026-07-09',NULL,1,'2026-06-08 23:23:58','2026-06-08 23:23:58'),(7,'REF-001',2,2,'contado','pendiente',16.00,'2026-06-20 09:59:21',NULL,NULL,1,'2026-06-20 09:59:21','2026-06-20 09:59:21');
...
-- Dump completed on 2026-06-20 17:56:01
