...
mysqldump: Couldn't execute 'SHOW FUNCTION STATUS WHERE Db = 'sysinescolara'': Column count of mysql.proc is wrong. Expected 21, found 20. Created with MariaDB 100108, now running 100432. Please use mysql_upgrade to fix this error (1558)
