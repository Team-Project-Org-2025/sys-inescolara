...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='C├ílculo de precio por lote.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calculo_precio` VALUES (20,22,1.00,3.00,30.00,5.20,'2026-06-29',1),(21,23,1.00,1.00,30.00,2.60,'2026-06-29',1);
...
/*!40000 ALTER TABLE `calculo_precio_detalle` DISABLE KEYS */;
INSERT INTO `calculo_precio_detalle` VALUES (3,20,10,2.00),(4,20,2,1.00),(5,21,10,1.00);
/*!40000 ALTER TABLE `calculo_precio_detalle` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-28 22:18:53
