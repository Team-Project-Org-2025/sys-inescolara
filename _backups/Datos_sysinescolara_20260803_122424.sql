...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Nodo central entre talento humano y producci├│n.';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de clientes.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `cliente` VALUES (1,'V','31205896','Mayra','Perez','04123005646',1),(2,'V','12451590','Detzy','Acosta','04144237719',0),(3,'V','31205898','Detzy','Acosta','04144237719',0),(4,NULL,NULL,'Detzy Acosta','','04144237719',0),(5,'V','12451590','Detzy','Acosta','04123005647',0),(6,'V','9876543','Pedro','Rojas','04161234501',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Inventario de insumos.';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de plantas.';
SET character_set_client = @saved_cs_client ;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de proveedores.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `proveedores` VALUES (1,'Plantas nuevas','J-123456789','Prueba','04123232323',0),(2,'Plantas nuevas','J-123456788','Maria Dantes','04144237719',0),(3,'Plantas nuevas','V-312057688','jueves','04144237719',1),(4,'jueves','J-636636664','jueves',NULL,0),(5,'Semillas Andinas C.A.','J-123456700','Ana Torres','04141234500',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Personal del vivero.';
SET character_set_client = @saved_cs_client ;
...
INSERT INTO `trabajadores` VALUES (1,'Enyell','Duarte','31511825','04120000000','Administrador',1),(2,'Juan Carlos','Pérez','V12345678','04141234567','Viverista',1),(3,'María Isabel','López','V23456789','04161234568','Secretaria',1),(4,'Carlos Alberto','Rodríguez','V34567890','04241234569','Técnico',1);
...
-- Dump completed on 2026-08-03 12:24:24
