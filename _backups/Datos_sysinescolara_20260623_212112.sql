...
INSERT INTO `cliente` VALUES (1,'Mayra Perez','04123005644',1),(2,'Anyelber Alvarado','04125555555',0),(3,'Anyelber Alvarado','04245280342',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo bot├ínico.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `especie` VALUES (1,'dsadasdasdasa',NULL,1),(2,'dadada',NULL,1),(3,'dsadasdasdasad',NULL,1),(5,'fdgdfg','fdgdfgdfg',0);
...
INSERT INTO `insumo` VALUES (2,14,'Fertilizante','dasd',0.01,0.01,0),(3,5,'Semillas de Simon','Semillas',0.00,10.00,0),(4,5,'Semillas de Simon','Semillas',20.00,0.00,0),(5,5,'Semillas de Simon','Semillas',20.00,0.00,0),(6,5,'Semillas de Simon','Semillas',4.00,20.00,1);
...
INSERT INTO `lote` VALUES (4,2,3,'2026-06-01',1,30,'Vivo','germinado','Siembra',NULL,'public/assets/uploads/batches/batch_1780330649_5cde51b9.jpg',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de plantas.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plantas` VALUES (2,1,'Cactuspro','asdasd',0,'public/assets/uploads/plants/plant_1780267336_412abda4.png',1),(4,2,'asda','rosa',0,NULL,0);
...
-- Dump completed on 2026-06-23 21:21:13
