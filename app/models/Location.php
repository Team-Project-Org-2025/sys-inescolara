...
class Location extends Database implements ReadableInterface, DeletableInterface
{
    ...
    {
        try {
            $sql = "SELECT id_ubicacion AS id, nombre_ubicacion, descripcion, zona FROM ubicacion ORDER BY nombre_ubicacion ASC";
    ...
    public function delete(int $id): bool
    {
        try {
            ...
            $stmt = $this->db->prepare("DELETE FROM ubicacion WHERE id_ubicacion = :id");
