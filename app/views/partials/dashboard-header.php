 ...
 * Variables esperadas: $user, $title
 */
?>
<header class="dashboard-header">
    ...
    <h1 class="dashboard-title"><?= htmlspecialchars($title ?? 'Dashboard') ?></h1>
    
    <div class="dashboard-header-actions">
        <button class="header-btn" id="notificationsBtn" aria-label="Notificaciones">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
