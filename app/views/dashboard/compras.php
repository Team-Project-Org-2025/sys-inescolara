...
<body>
    ...
    <!-- Add/Edit Modal -->
    <?php modal_form(['id' => 'compraModal', 'title' => 'Nueva Compra', 'formId' => 'compraForm', 'size' => 'modal-lg modal-dialog-centered', 'hasHiddenId' => true, 'titleId' => 'compraModalTitle', 'hiddenId' => 'compraId', 'saveText' => 'Guardar Compra']); ?>
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <?php modal_form_end('compraForm'); ?>

    <!-- Detail Modal -->
    <?php modal_detail_start(['id' => 'detailModal', 'title' => 'Detalle de Compra', 'size' => 'modal-lg modal-dialog-centered', 'bodyId' => 'detailBody']); ?>
